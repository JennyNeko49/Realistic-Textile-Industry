...
> - `mod/events/pjrti_events.txt`
> - `mod/common/on_action/pjrti_on_actions.txt`
...
2. **Run the `Initialize Mod Template` workflow**
  ...
  - When the workflow finishes, check [mod/events/abbreviation_event.txt](mod/events/abbreviation_event.txt):
    - The first line should now use your abbreviation instead of `pjrti_error_suppression`.
